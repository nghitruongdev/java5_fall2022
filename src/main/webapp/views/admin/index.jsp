...
<aside
    ...
    <div class="sidenav-header">
        <i
            ...
            class="ms-1 font-weight-bold text-white"> 2HANDS ADMIN</span>
    </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100"
        ...
        <ul class="navbar-nav">
            <li class="nav-item"><a
                ...
                <span class="nav-link-text ms-1">Quản lý Giày</span>
            </a></li>
            ...
            <nav aria-label="breadcrumb">
                <ol
                    ...
                    <li class="breadcrumb-item text-sm"><a
                            class="opacity-5 text-dark" href="javascript:;">2Hands
                        Admin</a></li>
                    <li class="breadcrumb-item text-sm text-dark active"
                        aria-current="page">Quản lý Sản Phẩm
                    </li>
                </ol>
                ...
                <ul class="navbar-nav  justify-content-end">
                    <div style="margin-top: 20px;" class="dropdown nav-item d-flex align-items-center">
                        ...
                        <i class="fa fa-user dropbtn btn btn-success dropdown-toggle"
                           ...
                           aria-expanded="false"> Hi, ${sessionAdmin.username}</i>
            ...
            <div class="col-12">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <c:forEach var="item" items="${listProduct}">
                                    <tr>
                                        ...
                                        <td class="align-middle text-center"><span
                                                class="text-secondary text-xs font-weight-bold">${item.category.name}</span>
                                        </td>
                                        <td class="align-middle text-center"><a
                                                href="/admin/index/update?maGiay=${item.id}"
                                                class="text-secondary font-weight-bold text-xs"> Chi
                                            tiết </a> <a href="/admin/index/delete?idGiay=${item.id}"
                                                         onclick="return confirm('Bạn có muốn xóa ${item.name} không?');"
                ...
                <div id="numberPageID">
                    ...
                    <a href="/admin/index?soTrang=<%=i%>"
                       class="btn btn-success numberPage activeCustom"><%=i%>
                    </a>
                    <%
                    } else {
                    %>
                    <a href="/admin/index?soTrang=<%=i%>"
                       class="btn btn-success numberPage"><%=i%>
                    </a>
                    <%
                                }
                            }
                    ...
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div
                            ...
                            , made with <i class="fa fa-heart"></i> by <a
                                ...
                                class="font-weight-bold" target="_blank">2Hands</a> for a
                            better web.
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="card-body pt-sm-3 pt-0">
            ...
            <div class="d-flex">
                <button class="btn bg-gradient-dark px-3 mb-2 active"
                        data-class="bg-gradient-dark" onclick="sidebarType(this)">Dark
                </button>
                <button class="btn bg-gradient-dark px-3 mb-2 ms-2"
                        data-class="bg-transparent" onclick="sidebarType(this)">Transparent
                </button>
                <button class="btn bg-gradient-dark px-3 mb-2 ms-2"
