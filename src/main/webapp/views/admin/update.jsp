		...
		<div class="container-fluid py-4">
			...
			<form method="post" style="width: 600px; margin: auto;"
				...
				<div class="form-group">
					<input name="maGiay" value="${productItem.id}" type="hidden"
						class="form-control" readonly
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				</div>
				<div class="form-group">
					<label>Tên giày</label> <input name="tenGiay"
						value="${productItem.name}" type="text" class="form-control"
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				</div>
				<div class="form-group">
					<label>Đơn giá</label> <input name="donGia"
						value="${productItem.price}" type="number" class="form-control"
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				</div>
				<div class="form-group">
					<label>Số lượng </label> <input name="donGia"
												  value="${productItem.quantity}" type="number" class="form-control"
												  style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				</div>
				<div class="form-group">
					<label>Categories</label> <select name="maLoaiGiay"
						class="form-control"
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
						<c:forEach var="item" items="${listCategory}">
							<c:choose>
								<c:when test="${item.id==productItem.category.id}">
				...
				<a class="btn btn-danger"
					href="/admin/index/delete?idGiay=${productItem.id}"
					onclick="return confirm('Bạn có muốn xóa ${productItem.name} không?');"
...
<main
    ...
    <div class="container-fluid py-4">
        ...
        <form method="post" style="width: 600px; margin: auto;"
            ...
            <div class="form-group">
                <label>Tên giày</label> <input name="tenGiay" type="text"
                                               class="form-control"
                                               style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Giảm giá (%)</label> <input name="giamGia" type="number"
